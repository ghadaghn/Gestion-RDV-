              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("choisir un médecin ou une spécialité", style: TextStyle(
                        fontSize: 30,
                      ...
                      Container(
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            ...
                            categoryContainer("category1.png", "Orthopédie"),
                            categoryContainer("category2.png", "Nutrition"),
                            categoryContainer("category3.png", "Généralité"),
                            categoryContainer("category4.png", "Neurologie"),
                            categoryContainer("category5.png", "Cardiologie"),
                            categoryContainer("category6.png", "IRM"),
                            categoryContainer("category8.png","Gynécologie"),
                          ],
                        ),
                      ),
                      Text("liste des médecins", style: TextStyle(
                        fontSize: 25,
                      ...
                      Container(    
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: <Widget>[
                              createDocWidget("doc1.png", "Wafa Fehri","Diplomée en échographie cardiaque de la Faculté de Médecine d'Amiens.Doctorat en recherche médicale de l'Université Laval"),
                              createDocWidget("doc2.png", "anis Jaoua","Neurologue et neurophysiologiste Ancien praticien des hôpitaux de Paris.Diplôme de pathologie vasculaire et AVC "),
                              createDocWidget("doc3.png", "fatma zouari","Spécialiste en gynécologie obstétrique Ancienne Assistante Hospitalo-universitaire à la faculté de médecine de Sfax."),
